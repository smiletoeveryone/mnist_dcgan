...
# Load data
train_set = datasets.MNIST('data/mnist_png/training/', train=True, download=True, transform=transform)
test_set = datasets.MNIST('data/mnist_png/testing/', train=False, download=True, transform=transform)
